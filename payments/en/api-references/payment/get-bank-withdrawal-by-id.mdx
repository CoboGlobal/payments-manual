---
openapi: get /payments/bank_withdrawals/{bank_withdrawal_id}
---

<RequestExample>
```python Python
import cobo_waas2
from cobo_waas2.models.payment_bank_withdrawal_detail import (
...
apiInstance.getBankWithdrawalById(bank_withdrawal_id).then(
  (data) => {
