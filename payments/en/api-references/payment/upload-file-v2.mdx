---
openapi: post /payments/files_v2
---
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload file v2
        api_response = api_instance.upload_payment_file_v2(
...
func main() {
	paymentUploadFileV2 := *coboWaas2.NewPaymentUploadFileV2(
	...
	resp, r, err := apiClient.PaymentAPI.UploadPaymentFileV2(ctx).
		PaymentUploadFileV2(paymentUploadFileV2).
		Execute()
	if err != nil {
...
const opts = {
  PaymentUploadFileV2: CoboWaas2.PaymentUploadFileV2.constructFromObject({
    file_name: "business_registration.pdf",
    file_content:
      "JVBERi0xLjQKJeLjz9MKMSAwIG9iago8PC9UeXBlL0NhdGFsb2cvUGFnZXMgMiAwIFI+PgplbmRvYmoK",
  }),
};
apiInstance.uploadPaymentFileV2(opts).then(
  (data) => {
