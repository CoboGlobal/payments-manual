---
openapi: get /payments/balance/bank_accounts/{bank_account_id}
---
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PaymentBankAccountBalance result =
          apiInstance.getPaymentBankAccountBalance(bankAccountId);
...
apiInstance.getPaymentBankAccountBalance(bank_account_id).then(
  (data) => {
