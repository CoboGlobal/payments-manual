...
For payment webhook events, please refer to [Order Status and Events](/payments/en/guides/status-and-events).
...
<img src="/payments/en/images/guides/webhook_data_structure.png" class="screenshot_full_screen" alt="Screenshot of the data property" />
