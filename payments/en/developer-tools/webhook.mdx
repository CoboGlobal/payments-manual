...
To create an endpoint and implement the handling logic, see [Set up a callback or webhook endpoint](/payments/en/developer-tools/set-up-endpoint).
...
To learn more about event types and event data types, see [Webhook event type and data type](/payments/en/developer-tools/webhook-event-type).
