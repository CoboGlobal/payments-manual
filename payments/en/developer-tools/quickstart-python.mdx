...
To implement file upload, merchant KYC submission, destination bank account creation, and off-ramp payout creation in one SDK flow, see [Third-party payout Python SDK integration](/payments/en/developer-tools/third-party-payout-python-sdk).
