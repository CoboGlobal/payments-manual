...
To implement a payouts-on-behalf-of workflow with the Python SDK, see [Payouts on behalf of (POBO)](/payments/en/guides/pobo). The guide covers KYC and bank account document upload, KYC submission, bank-account destination creation, and Off-ramp payout creation.
