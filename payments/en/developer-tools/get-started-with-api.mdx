...
<Note>You can skip this step if you choose to [use a Payments API SDK](/payments/en/developer-tools/quickstart-python), which offers ready-to-use functions that handle the API integration using the programming language of your project.</Note>
...
To learn how to install the Python SDK and complete the initial setup, refer to [Get started with Python SDK](/payments/en/developer-tools/quickstart-python).
