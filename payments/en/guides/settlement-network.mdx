...
Both events carry transaction-level payload fields. For the shared payload structure and delivery behavior, see [Events and status](/payments/en/guides/events/balances-and-settlement).
...
- [Events and status](/payments/en/guides/events/balances-and-settlement)
