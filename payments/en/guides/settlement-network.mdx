...
Both events carry transaction-level payload fields. For the shared payload structure and delivery behavior, see [Settlement Network events](/payments/en/guides/events/settlement-network).
...
- [Settlement Network events](/payments/en/guides/events/settlement-network)
