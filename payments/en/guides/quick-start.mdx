...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="/payments/en/guides/merchants">Merchant management</a> + <a href="/payments/en/guides/create-orders">Order</a>/<a href="/payments/en/guides/get-topup-addresses">Top-up mode</a> + <a href="/payments/en/guides/allocate-funds">Allocate funds</a> + <a href="/payments/en/guides/fiat-payouts">Off-ramp</a> / <a href="/payments/en/guides/enterprise-third-party-payouts">Enterprise third-party payouts</a></td>
    </tr>
    <tr>
...
As a payment service provider (PSP), you need to provide payment collection services for multiple merchants and achieve automated revenue sharing. A typical integration process is as follows:
  ...
  5. Payouts: Supports [Off-ramp](/payments/en/guides/fiat-payouts), [Enterprise third-party payouts](/payments/en/guides/enterprise-third-party-payouts), and [Crypto payouts](/payments/en/guides/crypto-payouts). Off-ramp and Enterprise third-party payouts require preconfigured, approved bank accounts in [Destinations](/payments/en/guides/destinations).
