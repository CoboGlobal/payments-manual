...
Find the integration profile(s) that match how you use Payments — if you use both pay-in modes, combine the two rows. Click any event name to jump to its full trigger condition and field descriptions.
