...
Find the integration profile(s) that match how you use Payments, and also subscribe to the shared events that apply to either pay-in mode. Click any event name to jump to its full trigger condition and field descriptions.
...
<table>
  ...
  <tbody>
    <tr>
      <td rowSpan={2}>**Receive payments in Order Mode**</td>
    ...
    <tr>
      <td rowSpan={2}>**Receive payments in Top-up Mode**</td>
    ...
    <tr>
      <td rowSpan={5}>**Receive payments in either mode**</td>
