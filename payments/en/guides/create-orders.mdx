...
| :-- | :-- | :-- | :-- | :-- |
| Scenario Description | - Pricing amount in fiat currency<br></br>- Developer fee not set<br></br>- System calculates payable amount | - Pricing amount in cryptocurrency<br></br>- Developer fee not set<br></br>- System calculates payable amount | - Pricing amount in fiat currency<br></br>- Developer fee set<br></br>- Custom payable amount | - Pricing amount in cryptocurrency<br></br>- Developer fee set<br></br>- System calculates payable amount |
...
<Info>For more information about developer fees, refer to [Accounts and fund allocation](/payments/en/guides/amounts-and-balances).</Info>
