...
For an end-to-end Python SDK example that creates an off-ramp payout after merchant KYC and Destination setup, see [Third-party payouts with Python SDK](/payments/en/developer-tools/third-party-payouts-python-sdk).
