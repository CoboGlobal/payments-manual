...
To pay a counterparty's bank account, see [Payouts on behalf of (POBO)](/payments/en/guides/pobo) for the end-to-end SDK workflow.
...
You can subscribe to the `payment.payout.status.updated` event to receive real-time updates on off-ramp status. Refer to [Webhook reference](/payments/en/guides/events/payouts) to understand the detailed trigger conditions and returned data structure of each event.
