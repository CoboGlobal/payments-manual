...
<Tabs>
  ...
  <Tab title="Payments API" icon="code">
    To implement the off-ramp payout flow with the Python SDK, see [Third-party payout Python SDK integration](/payments/en/developer-tools/third-party-payout-python-sdk).
