...
When registering an API key in the production environment, you need to note:
   ...
   * To further enhance security, you can configure a callback endpoint to approve payout requests. For more details, see [Configure callback endpoint](/payments/en/guides/preparation#optional-configure-callback-endpoint).
