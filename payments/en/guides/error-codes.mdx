...
| 2023                | Missing or invalid API signature.                                                                                      | Verify your API signature and ensure it is correct. You can refer to [Calculate the API signature](/payments/en/developer-tools/cobo-auth#calculate-the-api-signature) for details.                                                                                   |
...
| 2025, 4001                | Forbidden access to the requested resource.                                                             | Check the permissions associated with your API key. You can refer to [Permissions and wallet scopes](/payments/en/developer-tools/permissions-and-scopes) for details.                                                                               |
