...
For the end-to-end flow that creates an organization Destination and approved bank account for enterprise third-party OffRamp payouts, see [Enterprise third-party payouts](/payments/en/guides/enterprise-third-party-payouts).
