...
To create a destination bank account with the Python SDK as part of a third-party payout flow, see [Third-party payout Python SDK integration](/payments/en/developer-tools/third-party-payout-python-sdk).
