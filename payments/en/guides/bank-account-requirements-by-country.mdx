...
| --- | --- | --- |
| B2B company | `Organization` | `Company` |
| B2C individual | `Individual` | `Personal` |
...
| `destination_type` | Required. Use `Organization` for B2B or `Individual` for B2C. |
...
| `holder_type` | Required. Use `Company` for B2B or `Personal` for B2C. |
