...
| --- | --- | --- | --- |
| Hong Kong SAR (`HKG`) | Baseline. Do not provide `iban_code` or `routing_value`. | `payment_method` is `Swift`. | `HKG` |
