...
For a Python SDK example that submits merchant KYC as part of a third-party payout workflow, see [Third-party payouts with Python SDK](/payments/en/developer-tools/third-party-payouts-python-sdk).
