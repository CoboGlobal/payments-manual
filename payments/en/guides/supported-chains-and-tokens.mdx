...
The following stablecoin and chain combinations are available for payment collection:
...
| | Avalanche C-Chain | AVAXC_USDC2 | 18 | 0.05 USDC | AVAX |
| | Morph | MORPH_USDC1 | 100 | 0.05 USDC | MORPH |
| | Aptos | APT_USDC | 1 | 0.05 USDC | APT |
...
| | Avalanche C-Chain | AVAXC_USDT | 18 | 0.05 USDT | AVAX |
| | Morph | MORPH_USDT0 | 100 | 0.05 USDT | MORPH |
| | Aptos | APT_USDT | 1 | 0.05 USDT | APT |
| | X Layer | XLAYER_USDT0 | 100 | 0.05 USDT | OKB |
...
The token symbol part is not always the plain ticker — it can carry a suffix or an alternative spelling, as in `ARBITRUM_USDCOIN`, `MATIC_USDC2`, `MORPH_USDC1`, and `MORPH_USDT0`. Always use the exact `token_id` values listed in the supported tokens table above rather than constructing them by hand.

The following table maps each `chain_id` to its full chain name and network. These chains are supported for payment collection.
...
| `SOL` | Solana | Mainnet |
| `AVAXC` | Avalanche C-Chain | Mainnet |
| `MORPH` | Morph | Mainnet |
| `APT` | Aptos | Mainnet |
| `TRON` | TRON | Mainnet |
| `TON` | TON | Mainnet |
...
| AVAXC_USDC2 | Not supported | Not supported |
| MORPH_USDC1 | Not supported | Supported (bridging fee required) |
...
| AVAXC_USDT | Not supported | Not supported |
| MORPH_USDT0 | Not supported | Supported (bridging fee required) |
| APT_USDT | Not supported | Not supported |
| XLAYER_USDT0 | Not supported | Not supported |
