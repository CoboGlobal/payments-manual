...
端到端第三方资金转出集成示例请参阅[第三方资金转出 Python SDK 集成](/payments/cn/developer-tools/third-party-payouts-python-sdk)。

其他 API 操作级别的文档和示例代码请参照 Payments API SDK GitHub 仓库内的 [docs](https://github.com/CoboGlobal/cobo-waas2-python-api/tree/master/docs) 文件夹。
