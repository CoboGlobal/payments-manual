...
### 支付相关事件
支付相关的 Webhook 事件，请参考[事件与状态](/payments/cn/guides/status-and-events)。
...
<img src="/payments/en/images/guides/webhook_data_structure.png" className="screenshot_full_screen" alt="Webhook 数据结构截图" />
