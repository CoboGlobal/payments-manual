...
| :--- | :------- | :----- | :------- | :--------- |
| 资金转出被退回（Payout reversal） | 您发起的资金转出已完成后，该笔资金又在链上被退回到 Payment 收款地址或出金来源地址。 | 由对方在链上发起，您无需操作。退回资金会自动入账至您的开发者余额，无需人工介入。 | 资金流入：由外部收款地址退回至 Payment 地址。 | 不能使用 Create Refund API 或 Create Refund Link。请参考 [资金转出被退回](/payments/cn/guides/crypto-payouts#5-资金转出被退回)；退回资金按意外入账处理，不会在原资金转出记录上生成专门的退回状态。 |
| 合规冻结资金退回 | 入账资金被合规冻结，需通过合规资金处置流程退回。 | 合规流程，您无法自助发起。 | 资金流出：由冻结的入账资金退至处置目标地址。 | 不能使用 Create Refund API 或 Create Refund Link；应使用合规资金处置流程。 |
