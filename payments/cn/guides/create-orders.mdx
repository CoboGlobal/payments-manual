...
|  | 场景 1 | 场景 2 | 场景 3 | 场景 4 |
| :-- | :-- | :-- | :-- | :-- |
| 场景描述 | - 订单金额以法币计价<br></br>- 无需设置开发者费用<br></br>- 系统计算应付金额 | - 订单金额以加密货币计价<br></br>- 无需设置开发者费用<br></br>- 系统计算应付金额  | - 订单金额以法币计价<br></br>- 设置开发者费用<br></br>- 自定义应付金额 | - 订单金额以加密货币计价<br></br>- 设置开发者费用<br></br>- 系统计算应付金额 |
