...
<Info>有关资金分配机制的更详细介绍，请参考[账户与资金分配](/payments/cn/guides/amounts-and-balances)。</Info>
...
- 开发者费率设置：不同收款模式有不同的配置方式。关于费率配置和资金流向的详细说明，请参考[账户与资金分配](/payments/cn/guides/amounts-and-balances)。
