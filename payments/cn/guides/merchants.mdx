...
<Info>有关资金分配机制的更详细介绍，请参考[资金分配与余额管理](/payments/cn/guides/amounts-and-balances)。</Info>
...
- 创建商户：具体的商户创建和配置步骤请参考[开发环境前置准备](/payments/cn/guides/preparation#merchants)。

- 开发者费率设置：不同收款模式有不同的配置方式。关于费率配置和资金流向的详细说明，请参考[资金分配与余额管理](/payments/cn/guides/amounts-and-balances)。
